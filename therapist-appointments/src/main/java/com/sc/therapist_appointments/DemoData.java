...
public class DemoData {
    ...
    public static Schedule generateDemoData() {
        ...
        Therapist therapist1 = new Therapist("Therapist 1",   Arrays.asList(
                ...
                new Timeslot(DayOfWeek.TUESDAY, LocalTime.of(9, 0),  LocalTime.of(10, 0))), "Location A", List.of("Speech Therapy"));
        Therapist therapist2 = new Therapist("Therapist 2",    Arrays.asList(
                new Timeslot(DayOfWeek.MONDAY, LocalTime.of(9, 0), LocalTime.of(10, 0)),
                new Timeslot(DayOfWeek.TUESDAY, LocalTime.of(9, 0),  LocalTime.of(10, 0))) , "Location B", List.of("Occupational Therapy"));
